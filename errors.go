...
// Deprecated: Use [GasEstimationError] or [SimulationRevertError] instead.
// These dedicated types carry richer context (the built transaction, raw
// revert bytes, etc.) and are returned consistently on every error exit path.
//

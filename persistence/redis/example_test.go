...
func Example_multiTenant() {
	...
	appANonceStore := redisstore.NewNonceStore(client, redisstore.WithNonceStoreKeyPrefix("app-a"))

	appBTxStore := redisstore.NewTxStore(client, redisstore.WithTxStoreKeyPrefix("app-b"))
	appBNonceStore := redisstore.NewNonceStore(client, redisstore.WithNonceStoreKeyPrefix("app-b"))
